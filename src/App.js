  ...
  return (
    <div className="App">
      <div className="flex gap-8">
        <ProductCard img="https://photo.znews.vn/w660/Uploaded/bpivptvl/2025_07_07/tesla_models_caranddriver.jpg" status="New" name="Tesla Model 3 Standard Range Plus" price="360.000.000 đ" location="Florida, USA" year={2020} wheel="Rear-wheel Drive" fuel="Electric" seats={5}/>
        <ProductCard 
