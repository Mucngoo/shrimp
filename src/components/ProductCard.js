    ...
    return (
        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div class="mb-4 flex items-center justify-between gap-4">
                <div className="border border-blue-400 text-blue-400 px-2 py-1 rounded-lg bg-transparent">
                    {props.status}
                </div>
            ...
            <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{props.name}</a>

            <div class="mt-2 flex items-center gap-2">
                <p class="text-sm font-medium text-gray-900 dark:text-white">{props.price}</p>
                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{props.location}</p>
            </div>
            ...
            <ul class="mt-2 flex items-center gap-4">
                ...
                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{props.year}</p>
                </li>
                ...
                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{props.wheel}</p>
                </li>
            </ul>
            ...
            <ul class="mt-2 flex items-center gap-4">
                ...
                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{props.fuel}</p>
                </li>
                ...
                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{props.seats}</p>
                </li>
            </ul>
            </div>
        </div>
