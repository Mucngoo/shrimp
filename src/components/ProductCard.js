function ProductCard(props) {
    return (
        <div className="w-[80%] max-w-[355px] rounded-[3px] border bg-white p-4 max-h-[530px] dark:border-blue-300 dark:bg-gray-900">
            <div className="h-[12rem] w-full">
            <a href="#">
                <img className="mx-auto hidden h-full dark:block rounded-[3px]" src={props.img} alt="" />
            </a>
            </div>
            <div className="pt-2">
            ...
            <a href="#" className="text-xl font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{props.name}</a>

            <div className="mt-3 flex flex-col gap-2">
                <p className="text-xl font-medium text-blue-500">{props.price}</p>
                <p className="text-md text-gray-900 dark:text-white">{props.location}</p>
            </div>
            ...
            <ul className="mt-1 flex items-center gap-4">
                ...
                <p className="text-md text-gray-900 dark:text-white">{props.year}</p>
                </li>
                ...
                <p className="text-md text-gray-900 dark:text-white">{props.wheel}</p>
                </li>
            </ul>
            ...
            <ul className="mt-2 flex items-center gap-4">
                ...
                <p className="text-md text-gray-900 dark:text-white">{props.fuel}</p>
                </li>
                ...
                <p className="text-md text-gray-900 dark:text-white">{props.seats}</p>
                </li>
            </ul>
            </div>
        </div>
