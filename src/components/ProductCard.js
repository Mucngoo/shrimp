    ...
    return (
        <div className="w-[80%] max-w-[410px] rounded-[3px] border bg-white p-6 max-h-[560px] dark:border-blue-300 dark:bg-gray-900">
            ...
            <a href="#">
                ...
                <img className="mx-auto hidden h-full dark:block" src={props.img} alt="" />
            </a>
            </div>
            <div className="pt-6">
            <div className="mb-4 flex items-center justify-between gap-4">
                <div className="border border-blue-500 text-blue-500 px-3 rounded-lg bg-transparent">
                    {props.status}
                </div>
                ...
                <div className="flex items-center justify-end gap-1">
                    <div className="relative flex items-center justify-end gap-1 group">
                        ...
                        <div className="absolute bottom-full mb-2 hidden w-max rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white group-hover:block dark:bg-gray-700">
                            Add to favorites
                        </div>
                    </div>
                </div>
            ...
            <a href="#" className="text-2xl font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{props.name}</a>

            <div className="mt-3 flex flex-col gap-2">
                <p className="text-2xl font-medium text-blue-500">{props.price}</p>
                <p className="text-lg text-gray-900 dark:text-white">{props.location}</p>
            </div>
            ...
            <ul className="mt-1 flex items-center gap-4">
                ...
                <p className="text-lg text-gray-900 dark:text-white">{props.year}</p>
                </li>
                ...
                <p className="text-lg text-gray-900 dark:text-white">{props.wheel}</p>
                </li>
            </ul>
            ...
            <ul className="mt-2 flex items-center gap-4">
                ...
                <p className="text-lg text-gray-900 dark:text-white">{props.fuel}</p>
                </li>
                ...
                <p className="text-lg text-gray-900 dark:text-white">{props.seats}</p>
                </li>
            </ul>
            </div>
        </div>
